...
FLAGS=-ldflags "-X github.com/stork-oracle/gotrue/internal/utilities.Version=$(shell git describe --tags 2>/dev/null || echo 'dev')" -buildvcs=false
ifdef RELEASE_VERSION
	FLAGS=-ldflags "-X github.com/stork-oracle/gotrue/internal/utilities.Version=v$(RELEASE_VERSION)" -buildvcs=false
endif
